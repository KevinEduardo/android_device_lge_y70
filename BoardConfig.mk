...
-include vendor/lge/y70/BoardConfigVendor.mk
...
TARGET_BOOTLOADER_BOARD_NAME := y70
...
# RIL
BOARD_RIL_CLASS := ../../../device/lge/y70/ril/
...
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 2577399808
BOARD_USERDATAIMAGE_PARTITION_SIZE := 3979345920
...
TARGET_KERNEL_CONFIG := lge_y70_defconfig
...
TW_CRYPTO_REAL_BLKDEV := "/dev/block/mmcblk0p11"
...
# Selinux
BOARD_SEPOLICY_DIRS += device/lge/y70/sepolicy
