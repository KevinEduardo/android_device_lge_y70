...
$(call inherit-product-if-exists, vendor/lge/y70/y70-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/lge/y70/overlay

LOCAL_PATH := device/lge/y70

ifeq ($(TARGET_PREBUILT_KERNEL),)
	LOCAL_KERNEL := device/lge/y70/kernel
else
